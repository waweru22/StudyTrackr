...
import { Shield, Eye, EyeOff, AlertCircle, ArrowRight, UserPlus, LogIn } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center px-4">
            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-white">StudyTrackr Admin</h1>
                ...
                <div className="flex bg-slate-800/50 rounded-xl p-1 mb-6 border border-slate-700/50">
                    <button
                        ...
                        className={`flex-1 flex items-center justify-center space-x-2 py-2.5 rounded-lg text-sm font-semibold transition-all ${mode === 'login' ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/25' : 'text-slate-400 hover:text-slate-300'}`}
                    >
                        <LogIn size={16} />
                        <span>Sign In</span>
                    </button>
                    <button
                        ...
                        className={`flex-1 flex items-center justify-center space-x-2 py-2.5 rounded-lg text-sm font-semibold transition-all ${mode === 'register' ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/25' : 'text-slate-400 hover:text-slate-300'}`}
                    >
                        <UserPlus size={16} />
                        <span>Register</span>
                    </button>
                ...
                <div className="bg-slate-800/60 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-8 shadow-2xl">
                    <form onSubmit={mode === 'login' ? handleLogin : handleRegister} className="space-y-5">
                        ...
                        {success && (
                            <div className="text-green-300 text-sm bg-green-500/10 border border-green-500/20 p-3 rounded-xl">
                                {success}
                            </div>
                        )}
                        ...
                        >
                            <span>{loading ? (mode === 'login' ? 'Signing in...' : 'Registering...') : (mode === 'login' ? 'Sign In' : 'Create Admin Account')}</span>
